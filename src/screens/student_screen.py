...
def student_dashboard():
    ...
    for i, sub_node in enumerate(subjects):
        sub = sub_node.get('subject') or sub_node.get('subjects') or sub_node
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder='E.g. Joey Tribbiani')

            st.subheader('Optional: Voice Enrollment')
            st.info("Enroll your voice for attendence")

            audio_data = None 

            try:
               audio_data= st.audio_input("Record a short phrase like I'm present, my name is Joey.")
            except Exception:
                ...
                if new_name:
                    with st.spinner('Creating profile...'):
                        ...
                        if encodings:
                            ...
                            st.error('Couldnt capture your face features for registration')
